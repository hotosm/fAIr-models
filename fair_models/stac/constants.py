...
PROCESSING_SCHEMA = "https://stac-extensions.github.io/processing/v1.2.0/schema.json"
LABEL_SCHEMA = "https://stac-extensions.github.io/label/v1.0.1/schema.json"

MODEL_EXTENSIONS = [MLM_SCHEMA, VERSION_SCHEMA, CLASSIFICATION_SCHEMA, FILE_SCHEMA, PROCESSING_SCHEMA]
