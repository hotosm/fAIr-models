"""ZenML pipeline for YOLOv11m swimming pool detection.

Entrypoints referenced by models/yolo11m_swimming_pools/stac-item.json.
Pretrained weights: mozilla-ai/swimming-pool-detector (Ultralytics YOLO11m).
"""
...
def _coco_from_geojson_and_chips(chips_dir: Path, geojson_path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "categories": [{"id": 0, "name": "swimming_pool"}],
    }
